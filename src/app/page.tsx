        ...
        <div className="animate-section opacity-0 mt-[40vh]">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-10">
            ...
            <a
              ...
              className="hover:bg-opacity-25 transition-all duration-500 p-6 px-8 rounded-xl bg-green-400 bg-opacity-20 backdrop-blur-sm hover:border-green-500 border border-slate-800 text-lg cursor-pointer flex justify-between items-center"
            >
              <p>WhatsApp</p>
              <p className="text-sm opacity-50">+62 812-3456-7890</p>
            </a>
          </div>
        </div>
