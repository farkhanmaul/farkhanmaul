...
export default function Hero() {
  ...
  return (
    <div id="hero" className="relative w-screen min-h-screen flex flex-col px-6 sm:px-12 lg:px-20 py-12 gap-4" role="region">
      <div className="flex-grow grid grid-cols-1 lg:grid-cols-2 gap-8 relative">
        <div className="flex flex-col justify-center pl-4 sm:pl-[8vw] lg:pl-[4vw] pt-[10vh] sm:pt-[15vh] lg:pt-0 gap-6">
          <p className="text-lg sm:text-xl md:text-2xl font-normal flex items-center gap-3" id="hero-greeting">
          ...
          <div className="flex flex-col gap-3">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold ml-[-5px] text-cyan-400 flex gap-4 tracking-tight" id="hero-title">
              <span style={{ opacity: 0 }}>I&apos;m</span>
              <span style={{ opacity: 0 }} className="font-bold text-white">Farkhan</span>
          ...
          <p className="text-lg sm:text-xl md:text-2xl font-normal flex gap-2 text-zinc-100 max-w-2xl" id="hero-greeting2">
